...
The [`examples/calibration/calibrated_classifier_cv.cpp`](https://github.com/skigen-project/skigen/blob/main/examples/calibration/calibrated_classifier_cv.cpp) program renders a reliability curve comparing predicted positive-class probabilities with observed positive fractions:

<ExamplePlot
	alt="CalibratedClassifierCV reliability curve"
	stem="calibrated_classifier_cv_reliability"
/>
