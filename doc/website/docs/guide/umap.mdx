...
The [`examples/manifold/umap.cpp`](https://github.com/skigen-project/skigen/blob/main/examples/manifold/umap.cpp) program embeds three synthetic 3-D clusters into two dimensions:

<ExamplePlot
	alt="UMAP embedding of three synthetic Gaussian clusters"
	stem="umap"
/>
