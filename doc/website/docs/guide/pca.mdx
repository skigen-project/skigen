...
<ThemedImage
  alt="10-D Gaussian clusters projected to 2-D by Skigen::PCA and recovered by Skigen::KMeans"
  sources={{
    light: '/img/examples/pca_clustering_light.png',
    dark: '/img/examples/pca_clustering_dark.png',
  }}
/>
