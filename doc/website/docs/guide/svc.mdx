...
The [`examples/svm/svc.cpp`](https://github.com/skigen-project/skigen/blob/main/examples/svm/svc.cpp) program fits an RBF classifier on two Gaussian classes and renders its decision regions with support vectors highlighted:

<ExamplePlot
	alt="RBF SVC decision regions with support vectors highlighted"
	stem="svc_decision_regions"
/>
