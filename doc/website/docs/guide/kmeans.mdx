...
The [`examples/cluster/kmeans.cpp`](https://github.com/skigen-project/skigen/blob/main/examples/cluster/kmeans.cpp) program recovers three Gaussian clusters and renders them with [SkigenPlot](https://github.com/skigen-project/skigen-plot):
