...
The [`examples/cluster/kmeans.cpp`](https://github.com/skigen-project/skigen/blob/main/examples/cluster/kmeans.cpp) program groups three Gaussian clusters and renders them with [SkigenPlot](https://github.com/skigen-project/skigen-plot):
